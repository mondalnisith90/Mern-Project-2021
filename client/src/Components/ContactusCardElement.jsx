...
const ContactusCardElements = ({IconName, text, icon_color}) => {
    return(
        <>
         ...
         {text!="Linkedin"? <p style={{fontSize: "17px"}}>{text}</p> : <NavLink to={{pathname: "https://www.linkedin.com/in/nisithmondal/"}} target="_blank"> <p style={{fontSize: "15px"}}>{text}</p></NavLink>}
